...
namespace Projeto_PAP
{
    public partial class InserirReqSala : Form
    {
        ...
        private void observacoesTextBox_Validated(object sender, EventArgs e)
        {

        }

        private void observacoesTextBox_Validating(object sender, CancelEventArgs e)
        {
            if (observacoesTextBox.Text == "")
            {
                errorProvider1.SetError(observacoesTextBox, "Necessario inserir");
            }
        }
    }
}
